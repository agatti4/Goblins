...
def collision_ball_rotating_block(ball, block, dt, bounce=True):
    ...
    fauxBlock = pho.Block( block.getWin(), blockwidth, blockheight, [bp[0] - b0[0], bp[1] - b0[1] ] )
